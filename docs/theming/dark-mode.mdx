...
<Note>
  The `appearance` prop is the preferred way to set the color scheme. It accepts `'light'`, `'dark'`, or `'inherit'`.
  The legacy `mode` prop is still supported for backward compatibility.
</Note>
