  ...
  return (
    <PageContainer>
      <PageHeader showBackButton>
        <PageHeading>
          <Box>
            <Heading size={6}>Data List</Heading>
            <Text color={'gray'}>Displays metadata as a list of key-value pairs.</Text>
          </Box>
        </PageHeading>
      </PageHeader>
      <PageBody>
          ...
          <View style={styles.section}>
            ...
            <DataList.Root>
              <DataList.Item>
                ...
                <DataList.Value>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla ac nisl et libero
                  ultricies viverra quis vitae quam. Proin a feugiat metus. Donec vehicula purus at
                  nisi convallis, vel volutpat sem volutpat.
                </DataList.Value>
              </DataList.Item>
              <DataList.Item>
