        ...
        <ScrollView style={styles.container}>
          ...
          <Box style={styles.section}>
            ...
            <Text style={styles.description}>
              Only one item can be open at a time. With collapsible=true, the open item can be
              closed.
            </Text>
            <Accordion.Root
              type="single"
            ...
            >
              <Accordion.Item value="item-1">
                ...
                <Accordion.Content>
                  <Text>
                    This is the content for the first accordion item. It contains detailed
                    information that is revealed when the user taps the trigger.
                  </Text>
                </Accordion.Content>
              </Accordion.Item>
              <Accordion.Item value="item-2">
                ...
                <Accordion.Content>
                  <Text>
                    This is the content for the second accordion item. Each item can contain any
              ...
              <Accordion.Item value="item-3">
                ...
                <Accordion.Content>
                  <Text>
                    This is the content for the third accordion item. Notice how opening one item
                    closes the others.
                  </Text>
                </Accordion.Content>
              </Accordion.Item>
          ...
          <Box style={styles.section}>
            ...
            >
              <Accordion.Item value="item-1">
                ...
                <Accordion.Content>
                  <Text>
                    React Native lets you create native Android and iOS apps using JavaScript and
                    React. It provides a rich set of components and APIs for building mobile
                    applications.
                  </Text>
                </Accordion.Content>
              </Accordion.Item>
              <Accordion.Item value="item-2">
                ...
                <Accordion.Content>
                  <Text>
                    Expo is a framework for rapidly developing React Native applications. It
                    provides tools for building, deploying, and iterating on iOS, Android, and web
                    apps.
                  </Text>
                </Accordion.Content>
              </Accordion.Item>
              <Accordion.Item value="item-3">
                ...
                <Accordion.Content>
                  <Text>
                    ...
                    It helps catch errors early and improves the developer experience with great
                    tooling.
                  </Text>
                </Accordion.Content>
              </Accordion.Item>
          ...
          <Box style={styles.section}>
            ...
            >
              ...
              <Accordion.Item value="item-2">
                ...
                <Accordion.Content>
                  <Text>
                    This item is open by default using defaultValue prop. The component manages its
                    own state.
                  </Text>
                </Accordion.Content>
              </Accordion.Item>
          ...
          <Box style={styles.section}>
            ...
            <Text style={styles.description}>You can provide a custom icon to the trigger.</Text>
            <Accordion.Root type="single" collapsible style={styles.accordion}>
              <Accordion.Item value="item-1">
                <Accordion.Header>
