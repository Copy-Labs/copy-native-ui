...
export default function DialogDemo() {
  ...
  return (
    <ThemeProvider themeOptions={{ accentColor: 'indigo', radius: 'large', scaling: 1 }}>
      <PageContainer>
              ...
              <Flex direction={'column'} gap={32} padding={12}>
                <Box>
                  <Text color={'gray'} size={3}>
                    A dialog is a window that appears on top of the main application window and
                    blocks interaction with it.
                  </Text>
                  <Text color={'gray'} size={2} fontStyle={'italic'} weight={'medium'}>
                    (It can be used to ask the user for confirmation, or to display important
                    information. It can also be used to display a simple message.)
                  </Text>
                </Box>
