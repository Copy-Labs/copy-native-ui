                    ...
                    <Pressable>
                      <Card>
                        <Flex direction="column" gap={8}>
                          ...
                          <Text color="gray">Long press to see edit actions with shortcuts.</Text>
                        </Flex>
                      </Card>
                    </Pressable>
                  </ContextMenu.Trigger>
                    ...
                    <Pressable>
                      <Card>
                        <Flex direction="column" gap={8}>
                          ...
                          <Text color="gray">Long press to change the view mode.</Text>
                        </Flex>
                      </Card>
                    </Pressable>
                  </ContextMenu.Trigger>
                    ...
                    <Pressable>
                      <Card asChild>
                        <Flex direction="column" gap={8}>
                          ...
                          <Text color="gray">Some options may be disabled.</Text>
                        </Flex>
                      </Card>
                    </Pressable>
                  </ContextMenu.Trigger>
                    ...
                    <Pressable>
                      <Card>
                        <Flex direction="column" gap={8}>
                          ...
                          <Text color="gray">Long press to see destructive actions.</Text>
                        </Flex>
                      </Card>
                    </Pressable>
                  </ContextMenu.Trigger>
